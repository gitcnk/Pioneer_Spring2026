...
1. Create a new dataframe with countries in Africa for year 2002. Use only the following variables:
- Country
- Life expectancy
- Population
...
5. Write a code using ``dplyr`` syntax and $$\color{red}verbs$$ to list the names of the countries with 'low' life expectancy.
